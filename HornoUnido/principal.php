            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <a class="btn btn-outline-danger d-flex" href="cerrar_sesion.php" style="margin-right: 20px;">Cerrar sesión</a>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <section class="contenido" id="Inicio">
                    <div class="row">
                        ...
                        <div class="col-md-6"><br><br>
                            ...
                            <a class="cta" style="text-decoration: none;" href="comprar.php"><br>
